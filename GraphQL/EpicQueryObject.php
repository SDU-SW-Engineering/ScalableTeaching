...
class EpicQueryObject extends QueryObject
{
    const OBJECT_NAME = "Epic";

    public function selectAncestors(EpicAncestorsArgumentsObject $argsObject = null)
    {
    ...
    public function selectAuthor(EpicAuthorArgumentsObject $argsObject = null)
    {
    ...
    public function selectAwardEmoji(EpicAwardEmojiArgumentsObject $argsObject = null)
    {
    ...
    public function selectChildren(EpicChildrenArgumentsObject $argsObject = null)
    {
    ...
    public function selectCurrentUserTodos(EpicCurrentUserTodosArgumentsObject $argsObject = null)
    {
    ...
    public function selectDescendantCounts(EpicDescendantCountsArgumentsObject $argsObject = null)
    {
    ...
    public function selectDescendantWeightSum(EpicDescendantWeightSumArgumentsObject $argsObject = null)
    {
    ...
    public function selectDiscussions(EpicDiscussionsArgumentsObject $argsObject = null)
    {
    ...
    public function selectEvents(EpicEventsArgumentsObject $argsObject = null)
    {
    ...
    public function selectGroup(EpicGroupArgumentsObject $argsObject = null)
    {
    ...
    public function selectHealthStatus(EpicHealthStatusArgumentsObject $argsObject = null)
    {
    ...
    public function selectIssues(EpicIssuesArgumentsObject $argsObject = null)
    {
    ...
    public function selectLabels(EpicLabelsArgumentsObject $argsObject = null)
    {
    ...
    public function selectNotes(EpicNotesArgumentsObject $argsObject = null)
    {
    ...
    public function selectParent(EpicParentArgumentsObject $argsObject = null)
    {
    ...
    public function selectParticipants(EpicParticipantsArgumentsObject $argsObject = null)
    {
    ...
    public function selectUserPermissions(EpicUserPermissionsArgumentsObject $argsObject = null)
    {
