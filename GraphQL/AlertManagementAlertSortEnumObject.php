...
class AlertManagementAlertSortEnumObject extends EnumObject
{
    ...
    const ENDED_AT_DESC = "ENDED_AT_DESC";
    const CREATED_TIME_ASC = "CREATED_TIME_ASC";
    const CREATED_TIME_DESC = "CREATED_TIME_DESC";
    const UPDATED_TIME_ASC = "UPDATED_TIME_ASC";
    const UPDATED_TIME_DESC = "UPDATED_TIME_DESC";
    const EVENT_COUNT_ASC = "EVENT_COUNT_ASC";
    const EVENT_COUNT_DESC = "EVENT_COUNT_DESC";
