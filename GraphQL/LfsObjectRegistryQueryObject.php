...
class LfsObjectRegistryQueryObject extends QueryObject
{
    const OBJECT_NAME = "LfsObjectRegistry";
    ...
    public function selectLfsObjectId()
    {
        $this->selectField("lfsObjectId");
