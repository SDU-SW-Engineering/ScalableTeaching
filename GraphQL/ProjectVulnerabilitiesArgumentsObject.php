...
class ProjectVulnerabilitiesArgumentsObject extends ArgumentsObject
{
    protected $projectId;
    ...
    public function setClusterId(array $clusterId)
    {
    ...
    public function setClusterAgentId(array $clusterAgentId)
    {
