...
class ClusterAgentQueryObject extends QueryObject
{
    ...
    public function selectActivityEvents(ClusterAgentActivityEventsArgumentsObject $argsObject = null)
    {
        $object = new ClusterAgentActivityEventConnectionQueryObject("activityEvents");
        if ($argsObject !== null) {
