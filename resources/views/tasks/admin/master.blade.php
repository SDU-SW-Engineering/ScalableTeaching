        ...
        <div class="flex mb-4 justify-between items-center">
            ...
            <div>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('courses.tasks.show', [$course, $task]) }}" target="_blank" class="flex items-center bg-white hover:bg-gray-50 dark:bg-gray-600 text-gray-500 font-medium dark:text-gray-200 dark:border-none dark:hover:bg-gray-500 transition-colors ml-3 text-sm border rounded-lg px-4 py-3">
