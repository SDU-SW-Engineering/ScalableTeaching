<aside class="w-56 shrink flex-shrink-0 mr-4">
    <div>
        <a href="{{ route('courses.tasks.analytics.index', [$course->id, $task->id]) }}" @class(['flex items-center dark:text-white rounded-md py-2 px-2 dark:hover:bg-gray-800 hover:bg-gray-200', 'dark:bg-gray-800 bg-gray-200' => request()->route()->getName() == 'courses.tasks.analytics.index'])>
                    <span>
        ...
        <h4 class="dark:text-gray-400 text-xs uppercase font-bold mt-4 mb-2">Students</h4>
        ...
        <a href="#" class="flex items-center dark:text-white dark:hover:bg-gray-800 rounded-md py-2 px-2 mb-1">
            ...
            <span class="text-sm ml-1">Log</span>
        </a>
        <hr class="dark:border-gray-500 my-4">
        <h4 class="dark:text-gray-400 text-xs uppercase font-bold mt-4 mb-2">Progression</h4>
        ...
        <a href="#" class="flex items-center dark:text-white dark:hover:bg-gray-800 rounded-md py-2 px-2 mb-1">
            ...
            <span class="text-sm ml-1">Grading overview</span>
        </a>
        <a href="#" class="flex items-center dark:text-white dark:hover:bg-gray-800 rounded-md py-2 px-2">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
