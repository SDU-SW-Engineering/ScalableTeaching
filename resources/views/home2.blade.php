                        ...
                        <div class="content">
                            ...
                            @if(session()->has('success'))
                                <article class="message is-success">
                                    ...
                                    <div class="message-body">
                                        <p>Your assignment has been created successfully, click the lik below to access
                                            it.<br><b>If you get a 404 error, you are most likely not signed in to
                                                GitLab</b></p>
                                        <a href="https://gitlab.sdu.dk/projects/{{ session('success') }}"
                                           class="button is-small is-success mt-4 is-fullwidth">Go to Repo</a>
                                    </div>
                                </article>
                            @else
