    ...
    <div class="container px-6 mx-auto md:flex md:justify-between md:items-center">
        ...
        <div class="items-center md:flex h-full">
            <div class="flex flex-col md:flex-row items-center h-full">
                ...
                <a href="{{ route('courses.index') }}"
                   class="py-5 px-2 box-border text-sm border-b-4 border-transparent hover:border-lime-green-200 font-medium text-gray-700 dark:text-gray-200 md:mx-4 md:my-0">Courses</a>
