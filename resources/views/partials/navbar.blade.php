<nav class="bg-white shadow dark:bg-gray-800">
    <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center" v-scope="{ show: true }">
        <div class="flex items-center justify-between">
            <div>
                <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">WebTech</a>
            </div>
        ...
        <div class="items-center md:flex" :class="{'hidden': show}">
            <div class="flex flex-col md:flex-row md:mx-6">
                ...
                <a class="my-1 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-500 dark:hover:text-indigo-400 md:mx-4 md:my-0" href="#">{{ auth()->user()->getAuthIdentifierName() }}</a>
            </div>
