    ...
    <div class="px-6 pt-6 container mx-auto">
        <form action="{{ route('courses.store') }}" method="post">
            ...
            <div
                ...
                <button
                    class="flex-shrink-0 bg-white hover:bg-lime-green-500 text-lime-green-700 font-semi-bold hover:text-white py-2 px-4 border border-lime-green-500 hover:border-transparent rounded-lg"
                    type="submit">
                    Create
                </button>
            </div>
