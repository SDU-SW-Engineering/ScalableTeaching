...
@section('content')
    ...
    <div class="container mx-auto px-6 py-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <a class="bg-lime-green-100 text-lime-green-800 rounded-xl border border-lime-green-300 shadow hover:shadow-md flex flex-col items-center justify-center" href="{{ route("courses.create") }}">
