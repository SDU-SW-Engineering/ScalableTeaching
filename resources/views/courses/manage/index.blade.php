    ...
    <div class="px-6 pt-4 container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div>
                <div class="shadow-lg">
                    <header
                        class="bg-gray-200 dark:bg-gray-900 text-black dark:text-white rounded-t-lg text-lg px-6 py-4">
                        Teachers
                    </header>
                        ...
                        @if($errors->hasBag('teachers'))
                            <div class="bg-red-200 px-3 py-4 flex rounded mb-4 items-center">
                                ...
                                <div class="text-red-900">
                                    <div class="font-medium">There were {{ $errors->teachers->count() }} errors with
                                        your
                                        form
                                    </div>
