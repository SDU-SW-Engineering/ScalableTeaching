...
@section('content')
    <div class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
        <aside class="w-64" aria-label="Sidebar">
            ...
            <ul class="space-y-1">
                <li>
                    <a href="#" class="flex text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <span class="ml-3">Course 1</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <span class="ml-3">Course 2</span>
                    </a>
                </li>
            </ul>
        </aside>
