    ...
    <section>
        ...
        <div class="container px-6 py-16 mx-auto text-center bg-gray-100 rounded-xl shadow-lg bg-blob"
            ...
            <div class="max-w-lg mx-auto">
                ...
                <p class="mt-6 text-gray-500 dark:text-gray-300 mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing
    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="container px-6 py-8 mx-auto">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-lime-green-600 dark:text-lime-green-500 stroke-current" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p class="mt-2 text-gray-500 dark:text-gray-400">In total, <b class="text-lime-green-400">{{ $assignmentCount  }}</b> assignments have been created with an associated <b class="text-lime-green-400">{{ $projectCount }}</b> projects.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-500 dark:text-gray-400">During the last month <b class="text-lime-green-400">{{ $buildCount }}</b> builds have run, with an averge run time of <b class="text-lime-green-400">{{ number_format($buildAvg, 2) }}</b> seconds</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-500 dark:text-gray-400">Over the last month the average queue time has been <b class="text-lime-green-400">{{ number_format($avgQueue, 2) }}</b> seconds</p>
                </div>
            </div>
        </div>
    </section>
