...
@section('content')
    <section>
        <nav class="container p-6 mx-auto lg:flex lg:justify-between lg:items-center" v-scope="{ show: true }">
            ...
            <div class="flex flex-col mt-4 space-y-2 lg:mt-0 lg:flex-row lg:space-x-16 lg:space-y-0" :class="{'hidden': !show}">
        ...
        <div class="container px-6 py-16 mx-auto text-center dark:bg-gray-700 bg-gray-100 rounded-xl shadow-lg bg-blob" style="background-position: 50% 60%; background-size: cover;">
            <div class="max-w-lg mx-auto">
                ...
                <button
                    class="px-6 py-2 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-blue-600 rounded-lg hover:bg-blue-500 md:mx-0 md:w-auto focus:outline-none shadow-lg">
                    Get Started Now
                </button>
            </div>
