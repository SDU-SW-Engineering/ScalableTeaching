        ...
        <div class="flex gap-6 flex-wrap-reverse">
            <div class="flex-1 w-full lg:w-2/3 xl:w-4/6">
                <div class="flex gap-5 mb-3">
                    <button
                        class="bg-lime-green-100 dark:bg-gray-400 py-2 px-3 rounded-md text-lime-green-700 dark:text-gray-100 dark:hover:text-gray-100 hover:text-lime-green-700 font-semibold">
                        Description
                    </button>
                    <button
                        class="py-2 px-3 rounded-md font-semibold text-gray-700 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-500 dark:hover:text-gray-300">
                        Settings
                    </button>
                    <button
                        class="py-2 px-3 rounded-md font-semibold text-gray-700 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-500 dark:hover:text-gray-300">
            ...
            <div class="w-full lg:w-1/3 xl:w-2/6 mt-4 mb-4">
                <div v-if="hideMissingAssignmentWarning"
                ...
                <div class="bg-white shadow-lg p-4 rounded-md mt-8 dark:bg-gray-800">
                    ...
                    <p class="dark:text-gray-300">A total of <b>322</b> builds have completed during the task, of which you account for <b>44</b>.</p>
                </div>
            </div>
        </div>
    </div>
