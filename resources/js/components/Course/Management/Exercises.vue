                ...
                >
                    ...
                    >
                        <div
                            :class="[
                                group.name === null
                                    ? 'bg-gray-100 border dark:bg-gray-700 dark:border-none'
                                    : 'bg-gray-200 border border-gray-300 dark:bg-gray-800 dark:border-none',
                            ]"
                            class="shadow rounded-lg p-4 w-full"
                        >
                            <div
                                v-if="group.editing && reorganizing"
                            ...
                            >
                                <input
                                    ...
                                    id="name"
                                    name="name"
                                    class="disabled:bg-gray-200 dark:disabled:bg-gray-700 bg-gray-50 flex-grow border border-gray-300 text-gray-900 rounded-l focus:outline-none block w-full text-sm p-1 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"
                                />
                                <button
                                    :disabled="!canOrganize"
                            ...
                            <div v-else class="flex items-center">
                                <div class="cursor-pointer flex-grow">
                                    <span
                                        class="text-black dark:text-white font-lg"
                                        :key="group.name"
                                        v-text="
                                            group.name === null
                                                ? 'Ungrouped'
                                ...
                                <button
                                    ...
                                    v-if="group.name !== null && reorganizing"
                            ...
                            <!-- Possibly deprecated code? (Line 162 - 223) -->
                            <div
                                v-if="!reorganizing"
                                :class="[
                                    group.name === null
                            ...
                            >
                                ...
                                >
                                    ...
                                    TEKST IKKE HER
                                    <svg
                                        v-if="exercise.visible"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke-width="1.5"
                                        stroke="currentColor"
                                        class="flex-shrink-0 text-lime-green-200 dark:text-lime-green-400 ml-1 w-5 h-5"
                                    >
                                        <path
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                            ...
                            >
                                ...
                                >
                                    <span
                                        ...
                                        v-text="exercise.name"
                                    ></span>
                                    <div @click.stop.prevent="setVisibility(exercise)">
                                        <svg
                                            v-if="exercise.visible"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
            ...
            <div class="w-1/3">
                ...
                >
                    ...
                    >
                        ...
                        <div @click.stop.prevent="setVisibility(task)" v-if="!task.loading">
                            <svg
                                v-if="task.visible"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                ...
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="flex-shrink-0 text-lime-green-200 dark:text-lime-green-400 mx-0.5 w-5 h-5"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
...
export default {
    ...
    methods: {
        setVisibility: async function(task) {
            task.loading = true;
            task.showDropdown = false;
            await axios.post(task.toggleVisibilityRoute);
        ...
        save: async function () {
            ...
            this.sidebarGroup.forEach((exercise) =>
                exercises.push({
                    id: exercise.id,
                    group: "sidebar",
                })
    ...
    mounted() {
        this.groups = this.initialGroups.filter(
            (group) => group.name !== "sidebar"
        );
        this.sidebarGroup = this.initialGroups.filter(
            (group) => group.name === "sidebar"
        )[0].exercises;
    },
};
