<template>
    <div class="relative ml-3">
        <button :disabled="loading" @click="showDropdown = !showDropdown" id="dropdownDefault" data-dropdown-toggle="dropdown"
                :class="[accessible ? 'bg-lime-green-400 hover:bg-lime-green-500 focus:ring-lime-green-300 text-white' : 'bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500 focus:ring-gray-200 focus:ring-gray-600 text-gray-500 dark:text-gray-200']"
                ...
                type="button">
            <svg v-if="loading" :class="[accessible ? 'text-white' : 'text-gray-500 dark:text-gray-200']" class="animate-spin h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg"
            ...
            <svg v-if="!loading && accessible" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                 class="w-6 h-6">
            ...
            <svg v-if="!loading && !accessible" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path
            ...
            <span v-if="accessible">Teacher Gitlab access granted</span>
            <span v-else>Teacher Gitlab access revoked</span>
        ...
        <div v-show="showDropdown" id="dropdown"
            ...
            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                <li v-if="!accessible" @click="setVisibility(true)"
                    ...
                    <span>Give teachers admin access to Gitlab group</span>
                </li>
                <li v-if="accessible" @click="setVisibility(false)"
                    class="py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 flex items-center text-gray-500 cursor-pointer">
                    ...
                    <span>Remove teachers admin access to Gitlab group</span>
                </li>
            </ul>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        ...
        this.accessible = this.isAccessible
    },
    beforeDestroy() {
