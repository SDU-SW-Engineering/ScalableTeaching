<template>
    <div class="bg-white p-4 rounded-md shadow-md dark:bg-gray-800 flex">
        ...
        <div class="flex-1">
            ...
            <h1 class="text-black dark:text-white text-2xl font-bold" v-if="correctionType === 'all_tasks' || correctionType === 'required_tasks' || correctionType === 'number_of_tasks'">Tasks</h1>
