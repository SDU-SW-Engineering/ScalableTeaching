<template>
    <div v-if="comment != null" class="flex flex-col mb-4">
        <div class="flex justify-between rounded-t-md bg-white dark:bg-gray-900 dark:border-none border-t border-r border-l px-3 pt-3">
            <h2 class="text-sm dark:text-white font-medium">{{ file }}</h2>
        ...
        <div class="p-3 border-l border-r bg-white dark:bg-gray-900 dark:border-none">
            <div class="whitespace-nowrap bg-gray-800 flex flex-col p-4 rounded-t">
            ...
            <button class="bg-gray-300 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm w-full h-8 hover:bg-gray-400 dark:hover:bg-gray-600 hover:text-gray-700 dark:hover:text-gray-300 transition-colors  rounded-b">
                Show entire file
            </button>
        </div>
