            ...
            <div
                ...
                <div @click="toggleComment" class="flex cursor-pointer items-center">
                    ...
                    <div class="w-4 h-4 ml-1">
                        <svg v-if="context !== 'recipient' && (!isCommenting && this.relevantComments.length === 0)" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div v-else-if="context === 'recipient' && (!isCommenting && this.relevantComments.length === 0)"
                             class="hidden group-hover:block text-lime-green-400 w-4 h-4 fill-current">
                        </div>
