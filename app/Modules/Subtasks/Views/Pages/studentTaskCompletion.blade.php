...
@section('adminContent')
    ...
    <div class="dark:bg-gray-800 bg-gray-100 border px-4 py-3 mb-4 rounded-lg shadow-sm dark:text-white">
                        ...
                        <table class="min-w-full text-left text-sm font-light">
                            <thead class="border-b font-medium dark:border-neutral-500">
                                <tr>
                                    ...
                                    @endforeach
                                    <th scope="col" class="px-4 py-2 text-sm text-center">Total</th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach($projects as $project)
                                <tr class="border-b text-center dark:border-neutral-500">
                                    ...
                                    @endforeach
                                    <td class="font-bold">{{ $project['groups']->reduce(fn($carry, $cur) => $carry + $cur->sum('points'), 0) }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
