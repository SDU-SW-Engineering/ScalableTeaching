...
<x-sidebar-item name="Delegate" route="courses.tasks.admin.subtaskGradingAndFeedback.delegation.index"
...
<x-sidebar-item name="Feedback Moderation" route="courses.tasks.admin.subtaskGradingAndFeedback.feedback.index"
                :route-params="[$course, $task]">
